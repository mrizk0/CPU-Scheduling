...
#define DEBUG_FIFO_SCHED 1

#if DEBUG_FIFO_SCHED
#define DEBUG(fmt, args...) DEBUG_PRINT("fifo_sched: " fmt, ##args)
#else
#define DEBUG(fmt, args...)
#endif
#define ERROR(fmt, args...) ERROR_PRINT("fifo_sched: " fmt, ##args)
#define INFO(fmt, args...)  INFO_PRINT("fifo_sched: " fmt, ##args)
...
__attribute__((constructor)) void fifo_sched_init() {
  ...
  my_state->sim = sim_sched_register("fifo_sched", my_state, &ops);
}
